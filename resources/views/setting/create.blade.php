    ...
    <div class="py-12 min-h-screen bg-fixed w-full h-full text-primary-100 heropattern-jigsaw-white">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-4 sm:px-6 lg:px-8">
                <form class="space-y-6" action="{{ route('setting.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="mt-5 space-y-6 md:col-span-2 md:mt-0">
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="name" id="name" class="mt-2 block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                                <div>
                                    <label for="about"
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="description" id="description" class="mt-2 block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                        </div>

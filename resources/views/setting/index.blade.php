            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">เพิ่มหัวข้อเว็บไซต์</h1>
                        <p class="mt-2 text-sm text-gray-700">เพิ่มหัวข้อเว็บไซต์</p>
                    </div>
                        ...
                        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr>
                                        <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">ชื่อ
                                        </th>
                                        <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">คำอธิบาย
                                        </th>
                                    </tr>
                                    </thead>
                                    ...
                                    @if(!$data == null)
                                        @foreach($data as $b)
                                            <tr>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $b->description }}</td>
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                       ...
                                                       data-id="{{ route('setting.delete', $b->id) }}"
                                                       data-topic="{{ $b->name }}"
                                                       title="DELETE">
                                                        ลบ
                                                    </a>
